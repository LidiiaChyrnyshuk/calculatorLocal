...
})({"eYIK3":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9f58fc30f3ed6877";
"use strict";
...
document.addEventListener("DOMContentLoaded", ()=>{
    const lang = (0, _translate.getBrowserLanguage)();
    (0, _translate.changeLanguage)(lang);
    disableBonusButton();
...
function calculateBonus() {
    ...
    if (deposit < 20) {
        ...
        refsBonus.bonusText.textContent = (0, _translate.translateText)("minDeposit");
        refsBonus.bonusMessage.textContent = "";
        clearBonusDisplay();
        disableBonusButton();
        return;
    ...
    if (applicableBonus) {
        ...
        refsBonus.bonusText.textContent = (0, _translate.translateText)("yourBonus");
...
},{"./translate":"goUqX"}]},["eYIK3","1bQr6"], "1bQr6", "parcelRequireff1f", {})

//# sourceMappingURL=calculator.f3ed6877.js.map
